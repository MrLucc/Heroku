...
public class TemaControlador {
    ...
    @GetMapping("/findAll")
    public ResponseEntity<List<Tema>> findAllTheme() {
    ...
    @PostMapping("/save")
    public ResponseEntity<Tema> saveTheme(@Valid @RequestBody Tema novoTema) {
...
//    }
    ...
    @PutMapping("/update")
    public ResponseEntity<Tema> updateTheme(@Valid @RequestBody Tema temaParaAtualizar) {
