...
public class UsuarioControlador {
    ...
    public ResponseEntity<Object> register(@Valid @RequestBody Usuario novoUsuario) {
...
//    }
    ...
    @PutMapping("/update")
    public ResponseEntity<Usuario> update(@Valid @RequestBody Usuario usuarioParaAtualizar) {
        return ResponseEntity.status(201).body(repositorio.save(usuarioParaAtualizar));
    }

    @DeleteMapping("/deletar/{id_usuario}")
    public void deleteUserById(@PathVariable(value = "id_usuario") Long idUsuario) {
